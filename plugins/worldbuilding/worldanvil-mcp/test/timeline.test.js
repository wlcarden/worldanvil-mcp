...
describe("Timeline handlers", () => {
  ...
  describe("worldanvil_update_timeline", () => {
    ...
    it("converts history_ids array to { id } objects", async () => {
      ...
      expect(payload.histories).toEqual([
        { id: "h-1" },
        { id: "h-2" },
        { id: "h-3" },
      ]);
...
describe("History handlers", () => {
  ...
  describe("worldanvil_list_histories", () => {
    it("passes world_id and pagination options", async () => {
      ...
      expect(client.listHistories).toHaveBeenCalledWith("world-1", {
        offset: 10,
        limit: 25,
      });
    });
...
describe.skipIf(!hasCredentials)("Timeline & History Integration", () => {
  ...
  it(
    "creates a timeline with description, type, state, and tags",
    async () => {
  ...
  it(
    "updates timeline description and type",
    async () => {
  ...
  it(
    "creates a history event with year, date range, significance, and full content",
    async () => {
  ...
  it(
    "attaches history event to timeline via history_ids replace",
    async () => {
      expect(timelineId).toBeDefined();
      expect(historyId).toBeDefined();
  ...
  it(
    "updates history event title and date fields",
    async () => {
      expect(historyId).toBeDefined();
  ...
  it(
    "history event appears in world listing",
    async () => {
      expect(historyId).toBeDefined();
...
describe.runIf(!hasCredentials)(
  "Timeline & History Integration (Skipped)",
  () => {
